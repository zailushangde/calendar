...
class CalendarController(calendarService: CalendarService) extends Directives with JsonMapping {

  private val calendarsPathPrefix = pathPrefix(PathParts.Api / PathParts.Calendars)
